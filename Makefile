...
debug: src/load_data.c src/simulate.c src/main.c src/cuda_kernel.cu
	...
	mpicc -g -o bin/manifest-debug build/manifest-debug-load-data.o build/manifest-debug-simulate.o build/manifest-debug-main.o build/manifest-debug-cuda.o -L/usr/local/cuda/lib64/ -lcudadevrt -lcudart -lstdc++
...
release: src/load_data.c src/simulate.c src/main.c src/cuda_kernel.cu
	...
	mpicc -O3 -o bin/manifest build/manifest-load-data.o build/manifest-simulate.o build/manifest-main.o build/manifest-cuda.o -L/usr/local/cuda/lib64/ -lcudadevrt -lcudart -lstdc++
